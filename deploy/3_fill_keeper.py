    ...
    async with ClientSession(connector=TCPConnector(ssl=False)) as session:
        ...
        manifest = f'''
            ...
            CALL_METHOD
                ...
                Address("{validator}")
                Array<Tuple>(
                    Tuple(Decimal("112503808.801513554193972818"), Decimal("106955806.36878765118853036"),90720u64),
                    Tuple(Decimal("112379546.249481969264351765"), Decimal("106952894.987790161473865396"),88704u64),
